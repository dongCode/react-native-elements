...
```bash
yarn add @rneui/themed @dplus/rn-ui
```
...
```bash
npm install @dplus/rn-ui@edge @rneui/themed@edge
```
...
```bash
yarn add @dplus/rn-ui@edge @rneui/themed@edge
```
...
```bash
# @dplus/rn-ui
yarn add @dplus/rn-ui@github:react-native-elements/react-native-elements#base
...
```bash
yarn add  @dplus/rn-ui @rneui/themed react-native-web react-native-vector-icons
```
...
module.exports = override(
  ...
  babelInclude([
    path.resolve(__dirname, 'node_modules/@dplus/rn-ui'),
